...
it('renders correctly without a background dark ', () => {
  const tree = renderer
    .create(
      <Abstract
        description="Quis aute iure reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
...
it('renders correctly with a background image dark', () => {
  const tree = renderer
    .create(
      <Abstract
        overline="overlineTest"
...
it('renders correctly with a custom body and background dark', () => {
  const tree = renderer
    .create(
      <Abstract
        overline="overlineTest"
