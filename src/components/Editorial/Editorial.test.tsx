...
it('renders correctly center dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
...
it('renders correctly wide dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
...
it('renders correctly standard reversed dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
...
it('renders correctly reversed wide dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
...
it('renders correctly no label dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
...
it('renders correctly dots dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
...
it('renders correctly bold body element dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
          body={
            <p>
              ...
              elettorali. E, grazie all`integrazione con pagoPA, puoi anche
              pagare eventuali costi. Così, risparmi tempo e denaro.
            </p>
          }
          ctaButtons={[
            {
...
it('renders correctly label image dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
...
it('renders correctly rotated image dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
...
it('renders correctly ctas element dark', () => {
  const tree = renderer
    .create(
      <ThemeProvider theme={mainTheme}>
        <Editorial
